...
output_dir="$1"
val_dataset='../GeoMath_val.json'
val_result_dir="/data/gpfs/projects/punim1996/Data/AVR-RL/GeoMath/SFT/result/$model_name/val_result"
...
result_path="/data/gpfs/projects/punim1996/Data/AVR-RL/GeoMath/SFT/result/$model_name/infer_result/sft.jsonl"
#checkpoint_path="/data/gpfs/projects/punim1996/Data/AVR-RL/GeoMath/SFT/output/v4-20250926-105406/checkpoint-1250"
...
result_path="/data/gpfs/projects/punim1996/Data/AVR-RL/GeoMath/SFT/result/$model_name/infer_result/sft_OOD.jsonl"
if [ -f "$result_path" ]; then
    echo "文件存在，正在删除..."
    rm "$result_path"
    echo "文件已删除: $result_path"
...
swift infer \
    --adapters "$checkpoint_path" \
    --infer_backend pt \
    --val_dataset '../Geometry_test.json' \
    --temperature 0 \
    --max_new_tokens 4096 \
    --use_hf true \
    --max_batch_size 4 \
