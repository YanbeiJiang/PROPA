...
for epoch in $(seq 0 $((max_epoch-1))); do
    ...
    # # cp $checkpoint_dir/model.safetensors /data/projects/punim1996/Data/AVR-RL/RL_PRM_lora_7b/checkpoints/intern_checkpoint/rm_model
    # # cp $checkpoint_dir/config.json /data/projects/punim1996/Data/AVR-RL/RL_PRM_lora_7b/checkpoints/intern_checkpoint/rm_model
    # # cp $checkpoint_dir/generation_config.json /data/projects/punim1996/Data/AVR-RL/RL_PRM_lora_7b/checkpoints/intern_checkpoint/rm_model
        
    # SOURCE_DIR=$checkpoint_dir
    # DEST_DIR="./checkpoints_grpo/intern_checkpoint/rm_model"
