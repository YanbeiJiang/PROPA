...
for epoch in $(seq 4 8); do
    ...
    python bestN_test_intern.py --input "../../GeoMath_val.json" --output "../test/bestN_result/val_result/bestN_epoch${epoch_prev}.json"
...
# best_checkpoint="../output_grpo/output_grpo_epoch3_24/v1-20251004-175728/checkpoint-7"
# best_checkpoint_rm="../output_rm_grpo/output_rm_epoch3/v0-20251015-105253/checkpoint-12021"
# epoch_prev=3
...
python bestN_test_intern.py --input "../../GeoMath_test.json" --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}.json"

python get_accuracy.py --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}.json"

python bestN_test_intern.py --input "../../Geometry_test.json" --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}_OOD.json"

python get_accuracy.py --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}_OOD.json"
