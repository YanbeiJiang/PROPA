...
parser.add_argument("--output", type=str, default="/data/gpfs/projects/punim1996/Data/AVR-RL/GeoMath/RL_PRM/test/concatenate_inference_results_intern_without_training.json", help="output")
