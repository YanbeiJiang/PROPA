...
#     exit 1
# fi
# best_checkpoint="../output_grpo/output_grpo_epoch7_24/v0-20251017-211851/checkpoint-105"
# best_checkpoint_rm="../output_rm_grpo/output_rm_epoch7/v0-20251018-221112/checkpoint-12012"
# best_epoch_num=7
