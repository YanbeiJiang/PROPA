...
parser.add_argument("--dataset", type=str, default="/data/projects/punim1996/Data/AVR-RL/GeoMath/GeoMath_test.json", help="epoch")
parser.add_argument("--tree_path", type=str, default="/data/projects/punim1996/Data/AVR-RL/GeoMath/RL_PRM_lora_7b/tree_data_intern_test", help="epoch")
