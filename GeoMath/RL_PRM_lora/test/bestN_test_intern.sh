...
for epoch in $(seq 3 7); do
    ...
    python bestN_test_intern.py --input "../../GeoMath_val.json" --output "./bestN_result/val_result/bestN_epoch${epoch_prev}.json"

    accuracy_output=$(python get_accuracy.py --output "./bestN_result/val_result/bestN_epoch${epoch_prev}.json")
...
python bestN_test_intern.py --input "../../GeoMath_test.json" --output "./bestN_result/infer_result/bestN_epoch${epoch_prev}.json"

python get_accuracy.py --output "./bestN_result/infer_result/bestN_epoch${epoch_prev}.json"

python bestN_test_intern.py --input "../../Geometry_test.json" --output "./bestN_result/infer_result/bestN_epoch${epoch_prev}_OOD.json"

python get_accuracy.py --output "./bestN_result/infer_result/bestN_epoch${epoch_prev}_OOD.json"
