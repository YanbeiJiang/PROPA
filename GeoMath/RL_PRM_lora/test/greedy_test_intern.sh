...
for epoch in $(seq 3 7); do
    ...
    python greedy_test_intern.py --input "../../GeoMath_val.json" --output "./greedy_result/val_result/greedy_epoch${epoch_prev}.json"

    accuracy_output=$(python get_accuracy.py --output "./greedy_result/val_result/greedy_epoch${epoch_prev}.json")
...
python greedy_test_intern.py --input "../../GeoMath_test.json" --output "./greedy_result/infer_result/greedy_epoch${epoch_prev}.json"

python get_accuracy.py --output "./greedy_result/infer_result/greedy_epoch${epoch_prev}.json"

python greedy_test_intern.py --input "../../Geometry_test.json" --output "./greedy_result/infer_result/greedy_epoch${epoch_prev}_OOD.json"

python get_accuracy.py --output "./greedy_result/infer_result/greedy_epoch${epoch_prev}_OOD.json"
