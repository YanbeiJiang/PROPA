...
parser.add_argument("--dataset", type=str, default="/data/projects/punim1996/Data/AVR-RL/GeoMath/Geometry_test.json", help="epoch")
parser.add_argument("--tree_path", type=str, default="/data/projects/punim1996/Data/AVR-RL/GeoMath/RL_PRM_lora/tree_data_intern_test_OOD/all_epochs_result/checkpoint_7", help="epoch")
