...
output_dir="$1"
val_dataset='../GeoMath_val_ORM.json'
...
best_checkpoint="../Long_SFT/output_SFT_RL/v4-20251002-210009/checkpoint-4000"
...
swift infer \
    --adapters "$checkpoint_path" \
    --infer_backend pt \
    --val_dataset '../GeoMath_test_ORM.json' \
    --temperature 0 \
    --max_new_tokens 4096 \
    --use_hf true \
    --max_batch_size 4 \
...
swift infer \
    --adapters "$checkpoint_path" \
    --infer_backend pt \
    --val_dataset '../Geometry_test_ORM.json' \
    --temperature 0 \
    --max_new_tokens 4096 \
    --use_hf true \
    --max_batch_size 4 \
