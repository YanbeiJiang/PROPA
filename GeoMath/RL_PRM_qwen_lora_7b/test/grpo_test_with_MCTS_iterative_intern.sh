...
for batch_num in $(seq 0 $((max_batch_num_test-1))); do
    python MCTS_test_intern.py --epoch $best_epoch_num --batch_num $batch_num --batch_size 20 --input '../../GeoMath_test.json' --output_base '../tree_data_qwen_test'
done
echo "In Domain results: "
python find_best_path.py --epoch $best_epoch_num --dataset '../../GeoMath_test.json' --tree_path '../tree_data_qwen_test'

max_batch_num_test=40

for batch_num in $(seq 0 $((max_batch_num_test-1))); do
    python MCTS_test_intern.py --epoch $best_epoch_num --batch_num $batch_num --batch_size 20 --input '../../Geometry_test.json' --output_base '../tree_data_qwen_test_OOD'
done

echo "Out of Domain results: "
python find_best_path.py --epoch $best_epoch_num --dataset '../../Geometry_test.json' --tree_path '../tree_data_qwen_test_OOD'
