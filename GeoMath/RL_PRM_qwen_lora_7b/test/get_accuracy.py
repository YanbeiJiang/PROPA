...
parser.add_argument("--output", type=str, default="/data/projects/punim1996/Data/AVR-RL/GeoMath/RL_PRM_qwen_lora_7b/test/concatenate_inference_results_intern_Math_Vista.json", help="output")
