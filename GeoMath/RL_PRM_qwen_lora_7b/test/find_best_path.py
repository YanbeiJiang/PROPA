...
parser.add_argument("--dataset", type=str, default="/data/projects/punim1996/Data/AVR-RL/GeoMath/GeoMath_val.json", help="epoch")
parser.add_argument("--tree_path", type=str, default="/data/projects/punim1996/Data/AVR-RL/GeoMath/RL_PRM_qwen_lora_7b/tree_data_qwen_test/llm_judge_result/val_result/checkpoint_6", help="epoch")
