...
def find_best_path_by_model_reward(tree_data):
    # 构建 index -> node 映射
...
parser.add_argument("--dataset", type=str, default="/data/projects/punim1996/Data/AVR-RL/Math-Vision/Math_Vision_test.json", help="epoch")
parser.add_argument("--tree_path", type=str, default="/data/projects/punim1996/Data/AVR-RL/Math-Vision/RL_PRM_lora/tree_data_intern_test/all_epochs_result/checkpoint_9", help="epoch")
...
for json_file in json_files:
    if f"epoch{args.epoch}" in os.path.basename(json_file):
        ...
        best_path, best_terminal_node, best_avg_reward = find_best_path_by_model_reward(tree_data)
