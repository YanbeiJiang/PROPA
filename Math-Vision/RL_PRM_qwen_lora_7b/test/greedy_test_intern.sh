...
for epoch in $(seq 3 7); do
    ...
    python greedy_test_intern.py --input "../../Math_Vision_val.json" --output "../test/greedy_result/val_result/greedy_epoch${epoch_prev}.json"
...
python greedy_test_intern.py --input "../../Math_Vision_test.json" --output "../test/greedy_result/infer_result/greedy_epoch${best_epoch_num}.json"

python get_accuracy.py --output "../test/greedy_result/infer_result/greedy_epoch${best_epoch_num}.json"

python greedy_test_intern.py --input "../../DynaMath_test.json" --output "../test/greedy_result/infer_result/greedy_epoch${best_epoch_num}_OOD.json"

python get_accuracy.py --output "../test/greedy_result/infer_result/greedy_epoch${best_epoch_num}_OOD.json"
