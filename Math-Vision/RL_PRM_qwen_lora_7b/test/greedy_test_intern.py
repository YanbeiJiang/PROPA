...
parser.add_argument("--output", type=str, default="/data/gpfs/projects/punim1996/Data/AVR-RL/Math-Vision/RL_PRM_qwen_lora/test/concatenate_inference_results_intern_without_training.json", help="output")
...
# with open("/data/gpfs/projects/punim1996/Data/AVR-RL/Math-Vision/RL_PRM/test/concatenate_inference_results_intern.json", 'r') as f:
#     results = json.load(f)
