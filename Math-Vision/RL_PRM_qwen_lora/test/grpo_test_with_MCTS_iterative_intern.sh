...
for epoch in $(seq 3 7); do
    ...
    # python save_checkpoints_intern.py --checkpoint $checkpoint_dir --save_dir "/data/projects/punim1996/Data/AVR-RL/RL_PRM/checkpoints/qwen_checkpoint_test/policy_model"
    ...
    for batch_num in $(seq 0 $((max_batch_num_test-1))); do
        python MCTS_test_intern.py --epoch $epoch_num_prev --batch_num $batch_num --batch_size 20 --input '../../Math_Vision_val.json' --output_base $val_result_dir
    done

    #python find_best_path.py --epoch $epoch_num_prev --dataset '../../Math-Vision_val.json' --tree_path $val_result_dir


    accuracy_output=$(python find_best_path.py --epoch $epoch_num_prev --dataset '../../Math_Vision_val.json' --tree_path $val_result_dir)
...
#best_checkpoint="../output_grpo/output_grpo_epoch4_24/v3-20251003-174007/checkpoint-221"
#best_checkpoint_rm="../output_rm_grpo/output_rm_epoch4/v1-20251014-210609/checkpoint-18515"
#best_epoch_num=4
...
max_batch_num_test=19

for batch_num in $(seq 0 $((max_batch_num_test-1))); do
    python MCTS_test_intern.py --epoch $best_epoch_num --batch_num $batch_num --batch_size 16 --input '../../Math_Vision_test.json' --output_base '../tree_data_qwen_test'
done
echo "In Domain results: "
python find_best_path.py --epoch $best_epoch_num --dataset '../../Math_Vision_test.json' --tree_path '../tree_data_qwen_test'

max_batch_num_test=35

for batch_num in $(seq 0 $((max_batch_num_test-1))); do
    python MCTS_test_intern.py --epoch $best_epoch_num --batch_num $batch_num --batch_size 20 --input '../../DynaMath_test.json' --output_base '../tree_data_qwen_test_OOD'
done

echo "Out of Domain results: "
python find_best_path.py --epoch $best_epoch_num --dataset '../../DynaMath_test.json' --tree_path '../tree_data_qwen_test_OOD'
