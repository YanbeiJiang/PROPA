...
for epoch in $(seq 3 7); do
    ...
    python bestN_test_intern.py --input "../../Math_Vision_val.json" --output "../test/bestN_result/val_result/bestN_epoch${epoch_prev}.json"
...
python bestN_test_intern.py --input "../../Math_Vision_test.json" --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}.json"

python get_accuracy.py --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}.json"

python bestN_test_intern.py --input "../../DynaMath_test.json" --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}_OOD.json"
