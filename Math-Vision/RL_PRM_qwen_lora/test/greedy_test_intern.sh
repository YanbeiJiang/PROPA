...
python greedy_test_intern.py --input "../../Math_Vision_test.json" --output "../test/greedy_result/infer_result/greedy_epoch${epoch_prev}.json"

python get_accuracy.py --output "../test/greedy_result/infer_result/greedy_epoch${epoch_prev}.json"

python greedy_test_intern.py --input "../../DynaMath_test.json" --output "../test/greedy_result/infer_result/greedy_epoch${epoch_prev}_OOD.json"
