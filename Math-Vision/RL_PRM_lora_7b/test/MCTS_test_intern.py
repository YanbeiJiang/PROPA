...
def mcts_main(args_dict):
    ...
    #output = f'/data/projects/punim1996/Data/AVR-RL/Math-Vision/RL_PRM_lora/tree_data_intern_test_OOD/tree_data_intern_epoch{epoch}_{start_index}.json'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--input", type=str, default='/data/projects/punim1996/Data/AVR-RL/Math-Vision/Math_Vision_test.json', help="checkpoint")
    parser.add_argument("--output_base", type=str, default='/data/projects/punim1996/Data/AVR-RL/Math-Vision/RL_PRM_lora/tree_data_intern_test', help="checkpoint")
