...
for epoch in $(seq 1 5); do
    ...
    rm -rf "../checkpoints_grpo_greedy/intern_checkpoint_test/policy_model/"*

    # Copy all contents from the source directory to the destination directory
    cp -r "${checkpoint_dir}/"* "../checkpoints_grpo_greedy/intern_checkpoint_test/policy_model"
    ...
    python greedy_test_intern.py --input "../../Trance_val.json" --output "../test/greedy_result/val_result/greedy_epoch${epoch_prev}.json"
...
# best_checkpoint="../output_grpo/output_grpo_epoch0_24/v1-20251019-084445/checkpoint-3"
# epoch_prev=0
#checkpoint_dir=../../RL_PRM/output_concate/v4-20250703-154815/checkpoint-5090
...
# Copy all contents from the source directory to the destination directory
cp -r "${best_checkpoint}/"* "../checkpoints_grpo_greedy/intern_checkpoint_test/policy_model"
...
python greedy_test_intern.py --input "../../Trance_test.json" --output "../test/greedy_result/infer_result/greedy_epoch${epoch_prev}.json"

python get_accuracy.py --output "../test/greedy_result/infer_result/greedy_epoch${epoch_prev}.json"

python greedy_test_intern.py --input "../../TranceL_test.json" --output "../test/greedy_result/infer_result/greedy_epoch${epoch_prev}_OOD1.json"

python get_accuracy.py --output "../test/greedy_result/infer_result/greedy_epoch${epoch_prev}_OOD1.json"

python greedy_test_intern.py --input "../../TranceR_test.json" --output "../test/greedy_result/infer_result/greedy_epoch${epoch_prev}_OOD2.json"

python get_accuracy.py --output "../test/greedy_result/infer_result/greedy_epoch${epoch_prev}_OOD2.json"
