...
for epoch in $(seq 1 5); do
    ...
    rm -rf "../checkpoints_grpo_bestN/intern_checkpoint_test/policy_model/"*

    # Copy all contents from the source directory to the destination directory
    cp -r "${checkpoint_dir}/"* "../checkpoints_grpo_bestN/intern_checkpoint_test/policy_model"
    ...
    DEST_DIR="../checkpoints_grpo_bestN/intern_checkpoint_test/rm_model"
    ...
    ./deploy_vllm_online_intern_policy_test_bestN.sh
    ./deploy_vllm_online_intern_rm_test_bestN.sh
    sleep 60


    python bestN_test_intern.py --input "../Trance_val.json" --output "../test/bestN_result/val_result/bestN_epoch${epoch_prev}.json"

    accuracy_output=$(python get_accuracy.py --output "../test/bestN_result/val_result/bestN_epoch${epoch_prev}.json")
...
# Copy all contents from the source directory to the destination directory
cp -r "${best_checkpoint}/"* "../checkpoints_grpo_bestN/intern_checkpoint_test/policy_model"
...
python bestN_test_intern.py --input "../Trance_test.json" --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}.json"

python get_accuracy.py --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}.json"

python bestN_test_intern.py --input "../TranceL_test.json" --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}_OOD1.json"

python get_accuracy.py --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}_OOD1.json"

python bestN_test_intern.py --input "../TranceR_test.json" --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}_OOD2.json"

python get_accuracy.py --output "../test/bestN_result/infer_result/bestN_epoch${epoch_prev}_OOD2.json"
