...
for epoch in $(seq 3 7); do
    ...
    epoch_prev=$((epoch - 1))
    val_result_dir="../tree_data_intern_test/val_result/checkpoint_${epoch}"
    if [ "$epoch" -eq 7 ]; then
        ...
        DEST_DIR="../checkpoints_grpo/intern_checkpoint_test/rm_model"
        ...
        for batch_num in $(seq 0 $((max_batch_num_test-1))); do
            python MCTS_test_intern.py --epoch $epoch_prev --batch_num $batch_num --batch_size 20 --input '../../Trance_val.json' --output_base $val_result_dir
        done
    fi
    #python find_best_path.py --epoch $epoch_num_prev --dataset '../../Trance_val.json' --tree_path $val_result_dir


    accuracy_output=$(python find_best_path.py --epoch $epoch_prev --dataset '../../Trance_val.json' --tree_path $val_result_dir)
...
#     exit 1
# fi
# best_checkpoint="../output_grpo/output_grpo_epoch6_24/v0-20251020-232223/checkpoint-160"
# best_checkpoint_rm="../output_rm_grpo/output_rm_epoch6/v0-20251021-111856/checkpoint-4499"
# best_epoch_num=7
...
# for batch_num in $(seq 0 $((max_batch_num_test-1))); do
#     python MCTS_test_intern.py --epoch $best_epoch_num --batch_num $batch_num --batch_size 20 --input '../../Trance_test.json' --output_base '../tree_data_intern_test'
# done
# echo "In Domain results: "
# python find_best_path.py --epoch $best_epoch_num --dataset '../../Trance_test.json' --tree_path '../tree_data_intern_test'

# max_batch_num_test=50

# for batch_num in $(seq 0 $((max_batch_num_test-1))); do
#     python MCTS_test_intern.py --epoch $best_epoch_num --batch_num $batch_num --batch_size 20 --input '../../TranceL_test.json' --output_base '../tree_data_intern_test_OOD1'
# done

# echo "Out of Domain Left results: "
# python find_best_path.py --epoch $best_epoch_num --dataset '../../TranceL_test.json' --tree_path '../tree_data_intern_test_OOD1'

max_batch_num_test=50

for batch_num in $(seq 0 $((max_batch_num_test-1))); do
    python MCTS_test_intern.py --epoch $best_epoch_num --batch_num $batch_num --batch_size 20 --input '../../TranceR_test.json' --output_base '../tree_data_intern_test_OOD2'
done

echo "Out of Domain Right results: "
python find_best_path.py --epoch $best_epoch_num --dataset '../../TranceR_test.json' --tree_path '../tree_data_intern_test_OOD2'
