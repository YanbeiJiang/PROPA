...
def generate_greedy(prompt, image_path, gpu_id):
        ...
        while attempts < 5:  # Retry up to 5 times
            try:
                ...
                #("generated text for greedy: ", generated_text)
...
parser.add_argument("--output", type=str, default="/data/gpfs/projects/punim1996/Data/AVR-RL/Trance/RL_PRM_qwen_lora/test/concatenate_inference_results_intern_without_training.json", help="output")
...
# with open("/data/gpfs/projects/punim1996/Data/AVR-RL/Trance/RL_PRM/test/concatenate_inference_results_intern.json", 'r') as f:
#     results = json.load(f)
